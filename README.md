...
│  (cloud, click   │  🖼️ image / 📎 attachment  📌 📦 ✏️ 🗑  │
│   to filter)     │                                       │
│                  │  ── Feb 20, 2026 ──────────────────   │
...
5. Use the filter tabs (All / Pinned / Archived) to switch views
6. Click a date on the calendar to filter memos for that day; use **Today** button to jump back to the current month
7. Click tags in the sidebar to filter by tag
8. Hover over a memo to see edit / pin / archive / delete actions
...
├── utils.ts              # Helpers: ID gen, tag extraction, markdown→HTML (images, attachments, links), dates
