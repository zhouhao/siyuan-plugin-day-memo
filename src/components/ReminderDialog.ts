...
export function showReminderDialog(
    ...
    const dialog = new Dialog({
        ...
        content: `<div class="b3-dialog__content">
            <label class="day-memo__reminder-label" style="display:block; font-size:13px; color:var(--b3-theme-on-surface-light); margin-bottom:6px;">
            ...
            <div class="day-memo__reminder-error" style="color: var(--b3-theme-error); font-size: 12px; margin-top: 6px; display: none;"></div>
        </div>
    ...
    const input = dialog.element.querySelector(".day-memo__reminder-input") as HTMLInputElement;
    const errorEl = dialog.element.querySelector(".day-memo__reminder-error") as HTMLElement;
    const cancelBtn = dialog.element.querySelector(".b3-button--cancel") as HTMLButtonElement;
    const saveBtn = dialog.element.querySelector(".day-memo__reminder-save") as HTMLButtonElement;
    const clearBtn = dialog.element.querySelector(".day-memo__reminder-clear") as HTMLButtonElement | null;
    ...
    saveBtn.addEventListener("click", () => {
        ...
        if (!value) {
            errorEl.textContent = i18n.reminderPastTime || "Please select a future time";
